...
sorted_distances.each_with_index do |distance, i|
  junction_box_pair = distance[0]
  add_to_circuit(circuits, junction_box_pair.a, junction_box_pair.b)

  if circuits.size == 1 && circuits[0].size == junction_boxes.size
    p junction_box_pair.a.x * junction_box_pair.b.x
    break
  end
end
